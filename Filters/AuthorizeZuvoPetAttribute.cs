...
namespace ZuvoPetLocalHost.Filters
{
    public class AuthorizeZuvoPetLocalHostAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        private readonly string[] _tiposUsuario;

        public AuthorizeZuvoPetLocalHostAttribute(params string[] tiposUsuario)
        {
