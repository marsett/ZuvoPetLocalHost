...
{
    [AuthorizeZuvoPetLocalHost("Adoptante")]
    public class AdoptanteController : BaseController
    {
        ...
        public AdoptanteController(ZuvoPetLocalHostContext context, IRepositoryZuvoPet repo, HelperPathProvider helperPath, IHubContext<ChatHub> hubContext)
        {
